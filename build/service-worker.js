(() => {
  ...
  (() => {
    ...
    const d = (e) => new URL(String(e), location.href).href.replace(new RegExp('^'.concat(location.origin)), '');
    function f(e) {
    ...
    function L(e) {
      return e !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
        ? (
            y || (y = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])
          ).includes(e)
          ? function () {
    ...
    function E(e) {
      return 'function' === typeof e
        ...
        : (e instanceof IDBTransaction &&
          ...
          w(e, m || (m = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(e, C) : e);
    }
    function q(e) {
    ...
    C = ((e) => ({ ...e, get: (t, s, n) => N(t, s) || e.get(t, s, n), has: (t, s) => !!N(t, s) || e.has(t, s) }))(C);
    s(229);
        ...
        this._upgradeDb(e),
          this._cacheName &&
            (function (e) {
              ...
              t && s.addEventListener('blocked', (e) => t(e.oldVersion, e)), q(s).then(() => {});
            })(this._cacheName);
      }
      async setTimestamp(e, t) {
        const s = { url: (e = K(e)), timestamp: t, cacheName: this._cacheName, id: this._getId(e) },
      ...
      constructor() {
        (this.updatedURLs = []),
          ...
          (this.cachedResponseWillBeUsed = async (e) => {
            ...
            if ('install' === t.type && s && s.originalRequest && s.originalRequest instanceof Request) {
    ...
    class O {
      constructor(e) {
        ...
        (this.cacheKeyWillBeUsed = async (e) => {
          ...
          const n = (null === s || void 0 === s ? void 0 : s.cacheKey) || this._precacheController.getCacheKeyForURL(t.url);
    ...
    class B {
      ...
      async fetch(e) {
        ...
        try {
          ...
          throw (
            (a &&
              (await this.runCallbacks('fetchDidFail', { error: o, event: s, originalRequest: a.clone(), request: r.clone() })),
            o)
          );
        }
      }
      ...
      async getCacheKey(e, t) {
        ...
        if (!this._cacheKeys[s]) {
          ...
          for (const e of this.iterateCallbacks('cacheKeyWillBeUsed'))
            n = W(await e({ mode: t, request: n, event: this.event, params: this.params }));
          this._cacheKeys[s] = n;
        }
      ...
      *iterateCallbacks(e) {
      ...
      async _ensureResponseSafeToCache(e) {
        ...
        for (const n of this.iterateCallbacks('cacheWillUpdate'))
          if (((t = (await n({ request: this.request, response: t, event: this.event })) || void 0), (s = !0), !t)) break;
      ...
      _useDefaultCacheabilityPluginIfNeeded() {
        ...
        for (const [s, n] of this.plugins.entries())
          n !== F.copyRedirectedCacheableResponsesPlugin &&
            (n === F.defaultPrecacheCacheabilityPlugin && (e = s), n.cacheWillUpdate && t++);
      ...
      addToCacheList(e) {
        ...
        for (const n of e) {
          ...
          if (this._urlsToCacheKeys.has(a) && this._urlsToCacheKeys.get(a) !== e)
            throw new t('add-to-cache-list-conflicting-entries', { firstEntry: this._urlsToCacheKeys.get(a), secondEntry: e });
    ...
    class z {
      ...
      handleRequest(e) {
        ...
        const a = n.origin === location.origin,
          { params: r, route: i } = this.findMatchingRoute({ event: s, request: t, sameOrigin: a, url: n });
        let o = i && i.handler;
        const c = t.method;
        if ((!o && this._defaultHandlerMap.has(c) && (o = this._defaultHandlerMap.get(c)), !o)) return void 0;
        let h;
        try {
        ...
        return (
          h instanceof Promise &&
            ...
            (h = h.catch(async (e) => {
              ...
              if (this._catchHandler) return this._catchHandler.handle({ url: n, request: t, event: s });
              throw e;
            })),
          h
        );
    ...
    self.addEventListener('activate', () => self.clients.claim()),
      (function (e) {
        ...
        { revision: 'f84030bc049fa65b07995a6967029e32', url: '/index.html' },
        { revision: null, url: '/static/css/main.ae240003.css' },
        { revision: null, url: '/static/js/453.bbc72baf.chunk.js' },
        { revision: null, url: '/static/js/main.3253e6a0.js' },
      ]),
      (function (e) {
        const t = G();
        Z(new ee(t, e));
    ...
    Z(
      (e) => {
        ...
        return 'navigate' === t.mode && !s.pathname.startsWith('/_') && !s.pathname.match(ne);
      },
        ...
        new (class extends j {
          constructor() {
            super(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}),
              this.plugins.some((e) => 'cacheWillUpdate' in e) || this.plugins.unshift(te);
          }
          async _handle(e, s) {
          ...
          plugins: [
            new (class {
              ...
              _getCacheExpiration(e) {
                ...
                return s || ((s = new A(e, this._config)), this._cacheExpirations.set(e, s)), s;
              }
